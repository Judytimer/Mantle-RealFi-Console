              ...
              <TableBody>
                {filteredAssets.map((asset) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getAssetTypeColor(asset.type)}`}
                      >
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <span
                      className={`inline-block mt-1 px-2 py-0.5 rounded-full text-xs font-medium ${getAssetTypeColor(asset.type)}`}
                    >
                      {getAssetTypeLabel(asset.type)}
                    </span>
                  </div>
